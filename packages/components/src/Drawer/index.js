...
class DumbDrawer extends React.Component {
  render() {
    if (this.props.open) console.log('drawer open');
    return (
      <StyleProvider>
        <PortalContainer>
          <Impl {...this.props} data-component="Drawer" />
        </PortalContainer>
      </StyleProvider>
    );
  }
...
class Drawer extends React.Component {
  ...
  handleKeyDown(event) {
    ...
    isEscape &&
      isFunction(this.props.handleClickOutside) &&
