                ...
                const drawer = (
                    ...
                    >
                        <SpacedGroup direction="vertical">
                            <p>
                                This is the drawer with a portaled select.
                                Will the selection of the option in the portaled dropdown be considered "outside"?
                            </p>
                            <SingleSelect
                                fullWidth
