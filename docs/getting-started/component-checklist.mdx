...
- [ ] `index.js` exports the main component as the default export
- [ ] `index.js` exports secondary components/functions as named exports

## Implementation Documentation

- [ ] each component declares `propTypes` with comment descriptions
- [ ] each component declares appropriate defaultProps
- [ ] each theme-enabled compnent declares `themeDefintion`
