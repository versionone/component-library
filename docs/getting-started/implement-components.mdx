...
Component directories should **always** export the main component as the **default export**. Other named exports are also allowed to be publicly exported; just be sure to document them (see [Document Components](./document-components)), too.
