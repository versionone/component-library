...
route: /getting-started/documenting-components
---

# Documenting Components

- Every package contains a `README.mdx` in package directory's root
- contains a short paragraph/written explanation of the component
- examples
- component's API
- component's Theme API
