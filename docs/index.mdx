...
2. [nodejs](https://nodejs.org/en/) ^10.15.1 <sup>`node -v` to check, run multiple versions of node via nvm ([windows](https://github.com/coreybutler/nvm-windows), [OSX/Linux](https://github.com/creationix/nvm))</sup>
